...
import { postCancelRequest, postRankRequest, postSolveRequest } from "../workers/analysisClient";
...
describe("App interactions", () => {
  ...
  it("uses precomputed opening moves for exact ranking before starting the worker", async () => {
    ...
    await waitFor(() => {
      expect(screen.getByRole("button", { name: "1 TREFL kandydat 9,000 1 1,0 50,0%" })).toBeTruthy();
    });
